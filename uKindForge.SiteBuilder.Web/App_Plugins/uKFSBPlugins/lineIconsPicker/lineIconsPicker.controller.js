angular.module("umbraco").controller("uKindForge.LineIconsController", function ($scope, $http) {
    $scope.selectedIcon = $scope.model.value || "lni-home";
    $scope.searchTerm = "";
    $scope.showDropdown = false;

    // Load JSON file
    $http.get("/App_Plugins/uKFSBPlugins/lineIconsPicker/lineIcons.json").then(function (response) {
